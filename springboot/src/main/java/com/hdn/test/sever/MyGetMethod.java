...
public class MyGetMethod {
    ...
    public String getWithCookies(HttpServletRequest request) {
        ...
        if (Objects.isNull(cookies)) return "你必须携带cookies信息来";
        for (Cookie cookie : cookies) {
            if (cookie.getName().equals("login") &&
                    cookie.getValue().equals("true")) return "这是一个需要携带cookies信息才能访问的get请求!";
        }
    ...
    private Map<String, Integer> page(Integer start, Integer end) {
